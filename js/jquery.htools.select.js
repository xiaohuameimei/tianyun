...
(function ($) {
    $.fn.extend({
        "goSelectInput": function (parms) {
            ...
            //开始加载代码
            var beforeHtml = '<div class="_htools-select rounded" style="height: ' + conf.height + 'px;line-height: ' + conf.height + 'px;width: ' + conf.width + 'px;" onclick="htools.select.doSelect(\'' + uuid + '\');">';
